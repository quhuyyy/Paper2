...
lab1 = dataset[dataset['labNum'] == 1]
lab2 = dataset[dataset['labNum'] == 2]
lab3 = dataset[dataset['labNum'] == 3]
lab4 = dataset[dataset['labNum'] == 4]
lab1 = lab1.drop(columns=["Prelab-timeSpent","Prelab-lastSubmit"])